...
class Score(object):
    ...
    def __init__(self):
        ...
        self.__asteroidBoard = Text(Point(100, 30), f"Asteroids Destroyed: {self.__asteroidCount}")
        self.__missileBoard = Text(Point(80,60), f"Missiles Fired: {self.__missilesFired}")
        self.__ufoBoard = Text(Point(85, 90), "UFO Destroyed!")
...
def main():
    win = GraphWin("Asteroids", 1600, 800, autoflush = False)
    ...
    scoreBoard = Score()  # Create a scoreboard object
    ...
    ufoList.append(Ufo(random.randrange(0, 600, 15), random.randrange(0, 600, 15)))  # Append a UFO to the ufo list
    ...
    scoreBoard.drawBoard(win)  # Draw the scoreboard to the window
    ...
    while play == True:
        ...
        for asteroid in asteroidList:
            ...
            if asteroid.collision(origin.getPoint()):
                ...
                over = exciter.getLose()  # Create a text object for game over message
                over.draw(win)  # Draw the message to the window
        ...
        if len(ufoList) == 0 and len(asteroidList) == 0:
            ...
            winner = exciter.getVictory()  # Create text object victory message
            winner.draw(win)  # Display Victory message
